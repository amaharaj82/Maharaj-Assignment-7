...
```{r}
Top.residuals<-Linear.model.top.residuals(iris2$Petal.Length~iris2$Petal.Width, 15)
summary(Top.residuals)
```

Here I will plot petallength with petal width.

```{r}
plot(iris$Petal.Length, iris2$Petal.Width, main="Scatterplot of Iris petal length by width",
