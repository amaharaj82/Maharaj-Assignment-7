...
ifelse(top.ten.percent == TRUE)
return(top.ten.percent)
}
  
```
2. Obtain a real dataset with quantitative response and explantory variable (n>=50). Plot these on a scatterplot wiht a regression line. Use your function to help you highlight the 10% largest residuals on the scatterplot.
